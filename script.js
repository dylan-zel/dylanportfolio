...
const projectSheets = {
  "lunabotics-2026": {
    ...
    images: ["assets/lunabotics-2026-02.jpg", "assets/lunabotics-2026-01.jpg", "assets/lunabotics-2026-fea.png", "assets/lunabotics-2026-excavation-cad.png", "assets/lunabotics-2026-rover-cad.png"],
    media: [
      { kind: "image", src: "assets/lunabotics-2026-02.jpg" },
      { kind: "image", src: "assets/lunabotics-2026-01.jpg" },
      { kind: "image", src: "assets/lunabotics-2026-fea.png" },
      { kind: "image", src: "assets/lunabotics-2026-excavation-cad.png" },
      { kind: "image", src: "assets/lunabotics-2026-rover-cad.png" }
    ],
  ...
  "lunabotics-2025": {
    ...
    images: ["assets/lunabotics2025.jpg", "assets/lunabotics-2025-field.jpg", "assets/img-0419.jpeg", "assets/cleanroom.jfif"],
    videos: [
      {
    ...
    media: [
      ...
      { kind: "video", title: "FDM Fabrication", src: "assets/lunabotics-2025-fdm.mp4" },
      ...
      { kind: "image", src: "assets/lunabotics-2025-electrical-layout.png" },
      { kind: "image", src: "assets/lunabotics-2025-fea.png" },
      { kind: "image", src: "assets/lunabotics-2025-gantt-chart.png" },
      { kind: "image", src: "assets/lunabotics-2025-field.jpg" },
      { kind: "image", src: "assets/img-0419.jpeg" },
      { kind: "image", src: "assets/cleanroom.jfif" }
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        media: { kind: "video", src: "assets/lunabotics-2025-fdm.mp4", position: "center center" }
      },
      {
        ...
        media: { kind: "image", src: "assets/lunabotics-2025-fea.png", position: "70% center" }
      },
      {
    ...
    extraMedia: [
      ...
      { kind: "image", src: "assets/regolith-testbed.png" },
      { kind: "image", src: "assets/lunabotics-2025-gantt-chart.png" },
      { kind: "image", src: "assets/lunabotics-2025-belt.jpg" },
      { kind: "image", src: "assets/lunabotics-2025-wheels.jpg" },
      { kind: "image", src: "assets/lunabotics-2025-dirt-testing.jpg" },
  ...
  lunabotics: {
    ...
    role: "Founder and Project Lead",
    image: "assets/lunabotics2025.jpg",
    images: ["assets/lunabotics2025.jpg", "assets/regolith-testbed.png", "assets/cleanroom.jfif"],
  ...
  ugv: {
    ...
    image: "assets/autonomousrover1.png",
    images: ["assets/autonomousrover1.png", "assets/img-1184.jpeg", "assets/img-1999.jpeg"],
    ...
    sections: [
      {
        ...
        media: { kind: "image", src: "assets/autonomousrover1.png" }
      },
      {
        ...
        media: { kind: "image", src: "assets/img-1184.jpeg" }
      },
      {
        ...
        media: { kind: "image", src: "assets/img-1999.jpeg" }
      }
    ],
    points: [
  ...
  "autonomous-ugv": {
    ...
    image: "assets/hero-rover.jpeg",
    images: ["assets/hero-rover.jpeg", "assets/img-2174.jpeg"],
    media: [
      { kind: "video", title: "Autonomous UGV Drive Test", src: "assets/autonomous-ugv-main-short.mov" },
      { kind: "image", src: "assets/hero-rover.jpeg" },
      { kind: "image", src: "assets/img-2174.jpeg" }
    ],
    videos: [
      {
        title: "Autonomous UGV Drive Test",
        src: "assets/autonomous-ugv-main-short.mov"
      }
    ],
    ...
    sections: [
      {
        ...
        media: { kind: "image", src: "assets/autonomous-ugv-closeup.png" }
      },
      {
        ...
        media: { kind: "image", src: "assets/autonomous-ugv-robot-platform.png" }
      }
    ],
    extraMedia: [
      { kind: "video", title: "Autonomous UGV Working Video", src: "assets/autonomous-ugv-working-video.mp4" },
      { kind: "image", src: "assets/autonomous-ugv-system-architecture.png" },
      { kind: "image", src: "assets/autonomous-ugv-robot-platform.png" },
      { kind: "image", src: "assets/hero-rover.jpeg" },
      { kind: "image", src: "assets/img-2174.jpeg" }
    ],
    points: [
  ...
  "project-slot-1": {
    ...
    image: "assets/xarm6-carriage.png",
    images: ["assets/xarm6-carriage.png", "assets/xarm6-project.png"],
    media: [
      { kind: "image", src: "assets/xarm6-carriage.png" },
      { kind: "video", title: "Original Design 1", src: "assets/xarm-original-design-1.mp4" },
      { kind: "video", title: "Original Design 2", src: "assets/xarm-original-design-2.mp4" },
      { kind: "image", src: "assets/xarm6-project.png" },
      { kind: "video", title: "Design Iteration V5", src: "assets/xarm-v5.avi" }
    ],
  ...
  "bright-electronics": {
    ...
    image: "assets/bright-electronics-line-follower-clean.png",
    images: ["assets/bright-electronics-line-follower-clean.png", "assets/bright-electronics-gearbox.png"],
    ...
    extraMedia: [
      { kind: "image", src: "assets/bright-electronics-line-follower-clean.png" },
      { kind: "image", src: "assets/bright-electronics-gearbox.png" }
    ],
    points: [
  ...
  urc: {
    ...
    image: "assets/spacebulls.png",
    images: ["assets/spacebulls.png", "assets/spacebulls1.png", "assets/spacebulls2.png", "assets/spacebulls3.jpg"],
    ...
    extraMedia: [
      { kind: "image", src: "assets/spacebulls.png" },
      { kind: "image", src: "assets/spacebulls1.png" },
      { kind: "image", src: "assets/spacebulls2.png" },
  ...
  regolith: {
    ...
    image: "assets/regolith-testbed.png",
    images: ["assets/regolith-testbed.png"],
  ...
  drone: {
    ...
    image: "assets/generativedesigndrone1.png",
    images: ["assets/generativedesigndrone1.png", "assets/generativedesigndrone.jpg", "assets/drone-generative-design-final.png"],
    ...
    extraMedia: [
      { kind: "image", src: "assets/generativedesigndrone1.png" },
      { kind: "image", src: "assets/generativedesigndrone.jpg" },
      { kind: "image", src: "assets/drone-generative-design-final.png" }
    ],
    points: [
  ...
  hopping: {
    ...
    image: "assets/buffalo-byte-main.png",
    images: ["assets/buffalo-byte-main.png"],
    ...
    extraMedia: [
      { kind: "image", src: "assets/buffalo-byte-main.png" }
    ],
    points: [
  ...
  "arduino-rover": {
    ...
    media: [
      ...
      { kind: "image", src: "assets/arduino-rover-obstacle.png" },
      { kind: "image", src: "assets/arduino-rover-electronics.png" }
    ],
    videos: [
      {
  ...
  "arduino-workshop-robot": {
    ...
    image: "assets/arduino-workshop-robot.png",
    images: ["assets/arduino-workshop-robot.png"],
    media: [
      { kind: "video", title: "Workshop Robot Test", src: "assets/arduino-workshop-robot-video.mov" },
      { kind: "image", src: "assets/arduino-workshop-robot.png" }
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        media: { kind: "image", src: "assets/arduino-workshop-robot.png" }
      },
      {
  ...
  "robotics-club-educational-robot": {
    ...
    images: ["assets/img-2967.jpg", "assets/ros-platform.png"],
    ...
    extraMedia: [
      ...
      { kind: "image", src: "assets/ros-platform.png" }
    ],
    points: [
  ...
  "robotics-club": {
    ...
    role: "President and Project Lead",
    image: "assets/hero-rover.jpeg",
    images: ["assets/hero-rover.jpeg", "assets/autonomousrover1.png", "assets/spacebulls1.png"],
  ...
  bioimpedance: {
    ...
    role: "Scientific Researcher",
    image: "assets/cleanroom.jfif",
    images: ["assets/cleanroom.jfif"],
  ...
  manufacturing: {
    ...
    image: "assets/regolith-testbed.png",
    images: ["assets/regolith-testbed.png", "assets/cleanroom.jfif"],
  ...
  "senior-design": {
    ...
    image: "assets/ugv-render.png",
    images: ["assets/ugv-render.png", "assets/regolith-testbed.png"],
